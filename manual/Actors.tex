...
\lstinputlisting[firstline=135,lastline=140]{../examples/message_passing/calculator.cpp}
...
\lstinputlisting[firstline=18,lastline=54]{../examples/composition/calculator_behavior.cpp}
